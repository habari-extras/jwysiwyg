...
class JWYSIWYG extends Plugin
{
	...
	{
		Stack::add('admin_header_javascript', $this->get_url() . '/jwysiwyg/jquery.wysiwyg.js', 'jquery.wysiwyg', 'jquery');
	...
	{
		Stack::add('template_header_javascript', $this->get_url() . '/jwysiwyg/jquery.wysiwyg.js', 'jquery.wysiwyg', 'jquery');
